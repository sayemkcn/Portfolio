...
public class CvController {
	...
	public void initBinder(WebDataBinder binder) {
		binder.registerCustomEditor(Date.class, new CustomDateEditor(new SimpleDateFormat("yyyy-dd-MM"), true, 10));
	}
	...
	public String createCvP1(@ModelAttribute Cv cv, BindingResult bindingResult,
			@RequestParam("personalInfo.profilePhoto") MultipartFile multipartFile, HttpSession httpSession)
			throws IOException {
